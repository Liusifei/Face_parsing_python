...
// add by liangji
template <typename Dtype>
void caffe_gpu_scalar_max(const int N, const Dtype alpha, const Dtype* b, Dtype* y);
template <typename Dtype>
void caffe_gpu_scalar_min(const int N, const Dtype alpha, const Dtype* b, Dtype* y);
